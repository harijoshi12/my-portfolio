  ...
  const portfolioData = [
    {
      ...
      features: ['Technologies:- React, Firebase', 'Fully Responsive', 'Custom Animated Cursor', 'SVG animations'],
    ...
    },
    {
      ...
      features: ['Signup & Login functionality', 'Live Edit functionality', 'Download resume in pfd formate with selectable text and clickable link'], 
    ...
    },
    {
      ...
      features: ['Technology:- Blockchain, Solidity', "start polling and voiting "],
      git_link:"https://github.com/", 
      live_demo_link:"https://harijoshi.in/"
    },
  ]
